...
function numberJoy(n) {
  ...
  return true if digit sum * reversed sum is equal to the input number
  
  create a var for the digit sum
    split it into digits
    sum them
  create a var for the reversed sum
  ...
  */
  ...
  const reversedSum = +digitSum.toString().split("").reverse().join("");
